...
const Page = () => {
  const codeSnippet = `await fetch("https://pingpanda-saas.vercel.app//api/v1/events", {
    method: "POST",
    body: JSON.stringify({
      category: "sale",
      fields: {
    ...
    <>
      <section className='relative py-24 sm:py-32 bg-brand-25'>
        <MaxWidthWrapper className='text-center'>
          <div className='text-center mx-auto flex flex-col items-center gap-10'>
            <div>
              <Heading>
                <span>Real-Time SaaS Insights,</span>
                <br />
                <span className='relative bg-gradient-to-r from-brand-700 to-brand-800 text-transparent bg-clip-text'>
                  Delived to Your Discord
                </span>
              </Heading>
            </div>
      ...
      <section className='relative py-24 sm:py-32 bg-brand-25'>
        <MaxWidthWrapper className='flex flex-col items-center gap-16 sm:gap-20'>
          ...
          <div className='grid gap-4 lg:grid-cold-3 lg:grid-rows-2'>
            {/* first grid element */}
                ...
                <div className='relative min-h-[30rem] w-full grow'>
                  <div className='absolute bottom-0 left-10 right-0 top-10 overflow-hidden rounded-tl-xl bg-gray-900 shadow-2xl"'>
                    ...
                    <div className='overflow-hidden'>
                      <div className='max-h-[30rem] px-4 py-2'>
                        <SyntaxHighlighter
                          language='typescript'
                          style={{
                            ...oneDark,
                            'pre[class*="language-"]': {
                              ...oneDark['pr e[class*="language-"]'],
